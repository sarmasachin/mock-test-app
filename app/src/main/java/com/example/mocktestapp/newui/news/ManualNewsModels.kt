    ...
    val items: List<ManualNewsItem> = buildList {
        ...
        add(
            ...
            ManualNewsItem(
                ...
                dateLabel = "11 Apr 2026, 10:30 AM",
        ...
        for (n in 5..22) {
            ...
            add(
                ...
                ManualNewsItem(
                    ...
                    dateLabel = "${(28 - (n % 18)).coerceAtLeast(1)} Mar 2026, ${String.format("%02d", 8 + (n % 10))}:${if (n % 2 == 0) "20" else "45"} ${if ((n % 3) == 0) "PM" else "AM"}",
